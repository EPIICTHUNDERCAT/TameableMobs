...
public class RenderTameableGuardian extends RenderLiving<TameableGuardian>
{
    private static final ResourceLocation TAMEABLEGUARDIAN_TEXTURE = new ResourceLocation(Reference.ID, "textures/entity/tameableguardian.png");
    private static final ResourceLocation TAMEABLEGUARDIAN_ELDER_TEXTURE = new ResourceLocation(Reference.ID, "textures/entity/tameableguardian_elder.png");
    private static final ResourceLocation TAMEABLEGUARDIAN_BEAM_TEXTURE = new ResourceLocation(Reference.ID, "textures/entity/tameableguardian_beam.png");
    int lastModelVersion;

    public RenderTameableGuardian(RenderManager renderManagerIn)
    {
        super(renderManagerIn, new ModelTameableGuardian(), 0.5F);
        this.lastModelVersion = ((ModelTameableGuardian)this.mainModel).getModelVersion();
    }

    public boolean shouldRender(TameableGuardian livingEntity, ICamera camera, double camX, double camY, double camZ)
    {
     ...
     */
    public void doRender(TameableGuardian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (this.lastModelVersion != ((ModelTameableGuardian)this.mainModel).getModelVersion())
        {
            this.mainModel = new ModelTameableGuardian();
            this.lastModelVersion = ((ModelTameableGuardian)this.mainModel).getModelVersion();
        }
        ...
        if (entitylivingbase != null)
        {
            ...
            this.bindTexture(TAMEABLEGUARDIAN_BEAM_TEXTURE);
     ...
     */
    protected void preRenderCallback(TameableGuardian entitylivingbaseIn, float partialTickTime)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(TameableGuardian entity)
    {
        return entity.isElder() ? TAMEABLEGUARDIAN_ELDER_TEXTURE : TAMEABLEGUARDIAN_TEXTURE;
    }
}