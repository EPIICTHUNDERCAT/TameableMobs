...
public class ModelTameableBat extends ModelBase{
	    ...
	    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwingAmount, float ageInTicks,
			...
			TameableBat tameableBat = (TameableBat) entitylivingbaseIn;

			if (tameableBat.isSitting()) {
				
				
		            this.batHead.rotateAngleX = limbSwingAmount * 0.017453292F;
		            this.batHead.rotateAngleY = (float)Math.PI - limbSwingAmount * 0.017453292F;
		        ...
		        {
		            this.batHead.rotateAngleX = limbSwingAmount * 0.017453292F;
		            this.batHead.rotateAngleY = limbSwingAmount * 0.017453292F;
	    ...
	    {
	        if (((TameableBat)entityIn).getIsBatHanging())
	        {
