...
public class ModelTameableShulker extends ModelBase
{
    private final ModelRenderer base;
    private final ModelRenderer lid;
    public ModelRenderer head;

    public ModelTameableShulker()
    {
    ...
    {
        TameableShulker TameableShulker = (TameableShulker)entityIn;
        float f = ageInTicks - (float)TameableShulker.ticksExisted;
        float f1 = (0.5F + TameableShulker.getClientPeekAmount(f)) * (float)Math.PI;
        ...
        if (TameableShulker.getClientPeekAmount(f) > 0.3F)
        {
