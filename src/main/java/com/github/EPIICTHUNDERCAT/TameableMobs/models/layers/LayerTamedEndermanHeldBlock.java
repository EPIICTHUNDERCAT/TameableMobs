...
public class LayerTamedEndermanHeldBlock implements LayerRenderer<TameableEnderman>
{
    private final RenderTameableEnderman endermanRenderer;

    public LayerTamedEndermanHeldBlock(RenderTameableEnderman endermanRendererIn)
    {
