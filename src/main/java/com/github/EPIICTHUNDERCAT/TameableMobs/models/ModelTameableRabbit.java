...
public class ModelTameableRabbit extends ModelBase
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        TameableRabbit TameableRabbit = (TameableRabbit)entityIn;
        ...
        this.jumpRotation = MathHelper.sin(TameableRabbit.setJumpCompletion(f) * (float)Math.PI);
