...
public class ModelTameableGuardian extends ModelBase
{
    ...
    {
        TameableGuardian TameableGuardian = (TameableGuardian)entityIn;
        float f = ageInTicks - (float)TameableGuardian.ticksExisted;
        ...
        float f1 = (1.0F - TameableGuardian.getSpikesAnimation(f)) * 0.55F;
        ...
        if (TameableGuardian.hasTargetedEntity())
        {
            entity = TameableGuardian.getTargetedEntity();
        }
        ...
        float f2 = TameableGuardian.getTailAnimation(f);
