...
public class LayerHeldItemTamedWitch implements LayerRenderer<TameableWitch>
{
    private final RenderTameableWitch witchRenderer;

    public LayerHeldItemTamedWitch(RenderTameableWitch witchRendererIn)
    {
        this.witchRenderer = witchRendererIn;
    }

    public void doRenderLayer(TameableWitch entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
