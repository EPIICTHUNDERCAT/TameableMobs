...
public class ModelTameableIronGolem extends ModelBase
{
    ...
    public ModelTameableIronGolem()
    {
        this(0.0F);
    }

    public ModelTameableIronGolem(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public ModelTameableIronGolem(float p_i46362_1_, float p_i46362_2_)
    {
        int i = 128;
        int j = 128;
    ...
    {
        TameableIronGolem TameableIronGolem = (TameableIronGolem)entitylivingbaseIn;
        int i = TameableIronGolem.getAttackTimer();
        ...
        {
            int j = TameableIronGolem.getHoldRoseTick();
