...
public class ModelTameableBlaze extends ModelBase
{
	...
	private float childZOffset;

    public ModelTameableBlaze()
    {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwingAmount, float ageInTicks,
		...
		TameableBlaze tameableBlaze = (TameableBlaze) entitylivingbaseIn;
		
		if (tameableBlaze.isSitting()) {
			
			blazeHead.offsetY = .05f;
			
			
			
		} else {
			
			blazeHead.offsetY = 0.0f;
