...
public class ModelTameableVillager extends ModelBase
{
    ...
    public ModelTameableVillager(float scale)
    {
        this(scale, 0.0F, 64, 64);
    }

    public ModelTameableVillager(float scale, float p_i1164_2_, int width, int height)
    {
