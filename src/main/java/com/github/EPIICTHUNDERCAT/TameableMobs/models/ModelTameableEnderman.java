...
public class ModelTameableEnderman extends ModelBiped {
	/** Is the enderman carrying a block? */
	public boolean isCarrying;
	/** Is the enderman attacking an entity? */
	public boolean isAttacking;

	public ModelTameableEnderman(float scale) {
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwingAmount, float ageInTicks,
		...
		TameableEnderman TameableEnderman = (TameableEnderman) entitylivingbaseIn;

		if (TameableEnderman.isSitting()) {

			bipedHead.offsetY = 0.0f;

			bipedBody.setRotationPoint(0.0F, 16.0F, 0.0F);
			bipedBody.offsetY = 0.09f;
			
			bipedRightLeg.setRotationPoint(-2.0F, 19.0F, 1.0F);
			bipedRightLeg.rotationPointX = -2f;
			bipedRightLeg.offsetY = 0.0f;
			bipedRightLeg.rotateAngleX = 0f;
			bipedLeftLeg.setRotationPoint(2.0F, 2.0F, 10.0F);
			bipedLeftLeg.rotationPointX = 2f;
			bipedLeftLeg.rotationPointZ = 0f;
			bipedLeftLeg.offsetY = 0f;
			bipedLeftLeg.rotationPointY = 0f;
