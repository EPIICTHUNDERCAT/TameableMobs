...
public class ModelTameableMagmaCube extends ModelBase
{
    ModelRenderer[] segments = new ModelRenderer[8];
    ModelRenderer core;

    public ModelTameableMagmaCube()
    {
    ...
    {
        TameableMagmaCube TameableMagmaCube = (TameableMagmaCube)entitylivingbaseIn;
        float f = TameableMagmaCube.prevSquishFactor + (TameableMagmaCube.squishFactor - TameableMagmaCube.prevSquishFactor) * partialTickTime;
