...
public class LayerTamedCustomHead implements LayerRenderer<EntityLivingBase>
{
    private final ModelRenderer modelRenderer;

    public LayerTamedCustomHead(ModelRenderer p_i46120_1_)
    {
    ...
    public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        if (itemstack != null && itemstack.getItem() != null)
        {
            ...
            boolean flag = entitylivingbaseIn instanceof TameableVillager || entitylivingbaseIn instanceof TameableZombie && ((TameableZombie)entitylivingbaseIn).isVillager();

            if (entitylivingbaseIn.isChild() && !(entitylivingbaseIn instanceof TameableVillager))
            {
                float f = 2.0F;
                float f1 = 1.4F;
