...
public class ModelTameableSkeleton extends ModelBiped
{
    public ModelTameableSkeleton()
    {
        this(0.0F, false);
    }

    public ModelTameableSkeleton(float modelSize, boolean p_i46303_2_)
    {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
    {
        ...
        if (itemstack != null && itemstack.getItem() == Items.BOW && ((TameableSkeleton)entitylivingbaseIn).isSwingingArms())
        {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        TameableSkeleton TameableSkeleton = (TameableSkeleton)entityIn;

        if (TameableSkeleton.isSwingingArms() && (itemstack == null || itemstack.getItem() != Items.BOW))
        {
